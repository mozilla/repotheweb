...
define('simulator', ['config', 'jschannels', 'utils'], function (config, jschannels, utils) {
    return {        
...
require(['jschannels', 'simulator', 'utils', 'config'], function (jschannels, sim, utils, config) {
    var init = function () {    
